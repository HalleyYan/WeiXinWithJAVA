...
import hotpursuit.halley.pojo.Face;
...
public class FacePlusPlusUtil {
    ...
    private static List<Face> faceDetect(String picUrl) {  
        ...
        try {  
            ...
            queryUrl = queryUrl.replace("API_KEY", "f0285cd492991949312681aa5005ca0e");  
            queryUrl = queryUrl.replace("API_SECRET", "yakdR0MKtqd8Xu_2s1pEZYi9jPUZhMwW");  
            // 调用人脸检测接口   
